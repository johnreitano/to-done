...
1. **Read Product Mission**: Load `spekka/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `spekka/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `spekka/product/tech-stack.md` to understand:
