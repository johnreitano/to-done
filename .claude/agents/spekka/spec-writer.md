...
cat spekka/specs/[current-spec]/planning/requirements.md

# Check for visual assets
ls -la spekka/specs/[current-spec]/planning/visuals/ 2>/dev/null | grep -v "^total" | grep -v "^d"
```
...
Write the main specification to `spekka/specs/[current-spec]/spec.md`.
