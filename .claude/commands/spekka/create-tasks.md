...
- `spekka/specs/[this-spec]/spec.md`
- `spekka/specs/[this-spec]/planning/requirements.md`
...
Please direct me to where I can find those.  If you haven't created them yet, you can run /spekka:shape-spec or /spekka:write-spec.
```
...
- `spekka/specs/[this-spec]/spec.md` (if present)
- `spekka/specs/[this-spec]/planning/requirements.md` (if present)
- `spekka/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `spekka/specs/[this-spec]/tasks.md`

NEXT STEP 👉 Run `/spekka:implement-tasks` (simple, effective) or `/spekka:orchestrate-tasks` (advanced, powerful) to start building!
```
